		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#navigationandrouting5navigationandroutingproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationandrouting5navigationandroutingproject5-display": {
								"semanticObject": "navigationandrouting5navigationandroutingproject5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationandrouting5.navigationandroutingproject5",
									"url": sap.ui.require.toUrl("navigationandrouting5/navigationandroutingproject5")
								}
							}
						}
					}
